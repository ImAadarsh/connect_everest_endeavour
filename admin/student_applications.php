...
try {
    $stmt = $conn->query("SELECT * FROM student_applications ORDER BY created_at DESC");
...
<head>
    ...
    <title>Student Applications - Connect Everest Admin</title>
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="student_applications.php" class="active">
                ...
                <table id="applicationsTable" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($application['country']); ?></td>
    ...
    function viewApplication(application) {
        ...
        $('#modalCountry').text(application.country);
        $('#modalCourse').text(application.course);
        $('#modalEducation').text(application.education_level);
        $('#modalExperience').text(application.work_experience);
