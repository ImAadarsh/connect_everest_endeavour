...
<head>
    ...
    <meta name="keywords" content="Connect Everest, Employee, Job Opportunities">
    <meta name="description" content="Connect Everest - Find Your Dream Job in Europe">
    <meta name="author" content="">

    <!-- Title  -->
    <title>Employee - Connect Everest</title>
                ...
                <header class="contact-hed section-padding pb-0">
                    <div class="container">
                        <div class="caption mb-80 text-center">
                            <h1>Find Your Dream Job in Europe</h1>
                            <p class="mt-20">Connect with opportunities across Europe with our expert guidance</p>
                        </div>
                    </div>
                </header>
                            ...
                            <div class="col-lg-5 valign">
                                <div class="full-width md-mb80">
                                    <div class="sec-head md-mb80">
                                        <h2 class="text-u">
                                            Your Path to <br> European <span class="fw-200">Success</span>
                                        </h2>
                                        <p class="mt-20 mb-20">Connect Everest provides comprehensive support for professionals seeking opportunities in Europe. We specialize in connecting talented individuals from Nepal and India with employers across Europe.</p>
                                        
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="morinfo mt-30">
                                                    <h6 class="mb-15">Available Positions</h6>
                                                    <ul>
                            ...
                            <div class="col-lg-6 offset-lg-1 valign">
                                <div class="full-width">
                                    <div class="sec-head mb-50">
                                        <h6 class="sub-head">Start Your <span class="fw-200">Journey</span></h6>
                                    </div>
                                    <form id="employee-form" method="post" action="controller/employee.php">
                                        ...
                                        <div class="controls row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-30">
                                                    <input id="form_location" type="text" name="location" placeholder="Current Location" required="required">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group mb-30">
                                                    <input id="form_experience" type="text" name="experience" placeholder="Years of Experience">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
                                                    <textarea id="form_message" name="message" placeholder="Tell us about your skills and preferences" rows="4" required="required"></textarea>
                                                </div>
                                                <div class="mt-30">
